    ...
    igraph_matrix_t* pos)
{
  ...
  igraph_real_t weight_edge_crossings = mxIgraphGetReal(opts,
                                        "weightEdgeCross");
  igraph_real_t weight_node_edge_dist = mxIgraphGetReal(opts,
                                        "weightNodeEdgeDist");
                               ...
                               mxArray const* prhs[])
{
  ...
  layout_method_t method_table[MXIGRAPH_LAYOUT_N] = {
    ...
    [MXIGRAPH_LAYOUT_REINGOLDTILFORDCIRCULAR] = mxIgraph_reingold_tilford_circular_i
  };
