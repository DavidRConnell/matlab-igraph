...
%             igraph.correlatedPair.
    ...
    adj = mexIgraphRewire(adj, adjOptions.makeSparse, adjOptions.dtype, ...
                          adjOptions.isdirected, ...
                          methodOptions.preserveDegree, ...
                          methodOptions.probability, ...
                          methodOptions.nRewires, ...
                          methodOptions.mode, methodOptions.loops);
end
