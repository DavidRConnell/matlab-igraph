...
#if defined(_WIN64)
#  define rand_len_t unsigned __int64
#else
#  define rand_len_t mwSize
#endif

void mrRandu(double* arr, rand_len_t len);
void mrRandi(double* arr, rand_len_t len, double l, double h);
void mrRandn(double* arr, rand_len_t len);
